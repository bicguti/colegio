...
<?php echo form_open('url', array('class'=>'form-horizontal', 'role'=>'form')); ?>
    ...
    <div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<?php echo form_input(array('name'=>'nombre', 'class'=>'form-control', 'editar')); ?>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<?php echo form_input(array('name'=>'direccion', 'class'=>'form-control', 'required'=>'required', 'maxlength'=>'40', 'placeholder'=>'donce reside actualmente')); ?>
			</div>
		</div>
