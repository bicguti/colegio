...
se le presentan las areas y grados en los que puede agregar notas para zona, del bloque actual,
...
<?php if (count($areas) == 0 && count($areasD) == 0): ?>
 			...
 			<?php else: ?>
 <form action="<?=site_url()?>/notas" method="POST" class="form-horizontal" role="form">
 <div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title">NOTAS PARA ZONA</h3>
    </div>
