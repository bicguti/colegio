<?php //fomulario de consolidado anual ?>
...
<?php echo form_open('consolidados/exportar_consolidado_anual',array('class'=>'form-horizontal', 'role'=>'form', 'target'=>'_blank')); ?>
<div class="panel panel-success">
    <div class="panel-heading">
        <h3 class="panel-title">GENERACIÓN DE CONSOLIDADOS ANUALES POR NIVEL Y GRADO</h3>
    </div>
