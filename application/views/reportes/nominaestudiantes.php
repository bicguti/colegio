...
<p class="text-info">Modudo para ver la nomina de estudiantes por nivel y grado del ciclo academico actual.</p>
...
<div class="panel panel-success">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<select name="nivel" id="nivelNomina" class="form-control" required="required">
	...
	<div class="form-group" id="carrera" style="display:none">
		...
		<div class="col-sm-10">
			<select name="carrera" id="carreraNomina" class="form-control">
				<option value="">&lt;seleccione&gt;</option>
			</select>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<select name="grado" id="gradoNomina" class="form-control" required="required">
				<option value="">&lt;seleccione&gt;</option>
			</select>
		</div>
	</div>
